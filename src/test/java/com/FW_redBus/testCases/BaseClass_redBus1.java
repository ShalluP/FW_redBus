...
public class BaseClass_redBus1 {
	...
	public void setUpBrowser(String br)
	{
		...
		if (br.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					...
					read_config.getChromePath());
			ChromeOptions ops = new ChromeOptions();

			// ops.setBinary("C:\\Users\\Shallu\\AppData\\Local\\Google\\Chrome\\Application");
			//System.setProperty("webdriver.chrome.driver",	"C:\\Users\\Shallu\\Desktop\\Software testing\\Selenium Installation stuff\\Driver Executables\\chromedriver.exe");
